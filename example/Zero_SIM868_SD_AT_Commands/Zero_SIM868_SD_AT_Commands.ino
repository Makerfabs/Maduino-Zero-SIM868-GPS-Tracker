...
//Arduino Zero SIM868 GPS Tracker
...
//digitalWrite(LTE_RESET_PIN, LOW);
  ...
  //Get GNSS location
  sendData("AT+CGNSPWR=1", 1000, DEBUG);// turn the GPS on
  ...
  sendData("AT+HTTPPARA=\"URL\",\"http://www.makerfabs.com\"", 1000, DEBUG);
  sendData("AT+HTTPACTION=2", 1000, DEBUG);
  sendData("AT+CSQ", 1000, DEBUG);
  sendData("AT+HTTPHEAD", 1000, DEBUG);
  sendData("AT+HTTPREAD", 4000, DEBUG);
  sendData("AT+CSQ", 1000, DEBUG);
